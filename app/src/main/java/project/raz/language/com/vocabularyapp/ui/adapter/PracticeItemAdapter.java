...
public class PracticeItemAdapter extends RecyclerView.Adapter<PracticeItemAdapter.Holder> {

    ArrayList<WordBundle> wordBundles = new ArrayList<>();
    Context context;
    LayoutInflater inflater;

    public PracticeItemAdapter(Context context) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_practice_bundle, parent, false);
